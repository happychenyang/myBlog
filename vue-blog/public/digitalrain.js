...
$packages["main"] = (function() {
	...
	main = function() {
		...
		$global.addEventListener($externalize("load", $String), $externalize((function $b() {
			var _r, _r$1, _r$2, _r$3, _tuple, _tuple$1, cover, err, rain1, rain2, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; _r$1 = $f._r$1; _r$2 = $f._r$2; _r$3 = $f._r$3; _tuple = $f._tuple; _tuple$1 = $f._tuple$1; cover = $f.cover; err = $f.err; rain1 = $f.rain1; rain2 = $f.rain2; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			rain1 = [rain1];
			rain2 = [rain2];
			...
			_r = NewDigitalRain($global.document.body, level2Cols, 2, 8, 0.25); /* */ $s = 1; case 1: if($c) { $c = false; _r = _r.$blk(); } if (_r && _r.$blk !== undefined) { break s; }
			_tuple = _r;
			rain1[0] = _tuple[0];
			err = _tuple[1];
			...
			$global.document.getElementById('digitalrain').appendChild(cover);
			$global.addEventListener($externalize("resize", $String), $externalize((function(rain1, rain2) { return function $b() {
				var $s, $r;
				/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
				$r = rain1[0].layout(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
				$s = -1; return;
				/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$s = $s; $f.$r = $r; return $f;
			}; })(rain1, rain2), funcType));
			_r$2 = NewDigitalRain($global.document.body, level1Cols, 2, 12, 1); /* */ $s = 5; case 5: if($c) { $c = false; _r$2 = _r$2.$blk(); } if (_r$2 && _r$2.$blk !== undefined) { break s; }
			_tuple$1 = _r$2;
			rain2[0] = _tuple$1[0];
			err = _tuple$1[1];
			...
			$global.addEventListener($externalize("resize", $String), $externalize((function(rain1, rain2) { return function $b() {
				var $s, $r;
				/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
				$r = rain2[0].layout(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
				$s = -1; return;
				/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$s = $s; $f.$r = $r; return $f;
			}; })(rain1, rain2), funcType));
			rain2[0].Clicked = (function(rain1, rain2) { return function() {
				var _r$4, _r$5, _r$6, _r$7, _r$8, x, x$1, x$2, x$3, x$4;
				return;
				index = index + (1) >> 0;
				rain1[0].lowGlyphCanvas = (x = (_r$4 = index % 2, _r$4 === _r$4 ? _r$4 : $throwRuntimeError("integer divide by zero")), ((x < 0 || x >= lowGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : lowGlyphCanvases.$array[lowGlyphCanvases.$offset + x]));
				rain1[0].highGlyphCanvas = (x$1 = (_r$5 = index % 2, _r$5 === _r$5 ? _r$5 : $throwRuntimeError("integer divide by zero")), ((x$1 < 0 || x$1 >= highGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : highGlyphCanvases.$array[highGlyphCanvases.$offset + x$1]));
				rain2[0].lowGlyphCanvas = (x$2 = (_r$6 = index % 2, _r$6 === _r$6 ? _r$6 : $throwRuntimeError("integer divide by zero")), ((x$2 < 0 || x$2 >= lowGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : lowGlyphCanvases.$array[lowGlyphCanvases.$offset + x$2]));
				rain2[0].highGlyphCanvas = (x$3 = (_r$7 = index % 2, _r$7 === _r$7 ? _r$7 : $throwRuntimeError("integer divide by zero")), ((x$3 < 0 || x$3 >= highGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : highGlyphCanvases.$array[highGlyphCanvases.$offset + x$3]));
				$global.document.body.style.background = $externalize((x$4 = (_r$8 = index % 2, _r$8 === _r$8 ? _r$8 : $throwRuntimeError("integer divide by zero")), ((x$4 < 0 || x$4 >= backgrounds.$length) ? ($throwRuntimeError("index out of range"), undefined) : backgrounds.$array[backgrounds.$offset + x$4])), $String);
			}; })(rain1, rain2);
			$s = -1; return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f._r = _r; $f._r$1 = _r$1; $f._r$2 = _r$2; $f._r$3 = _r$3; $f._tuple = _tuple; $f._tuple$1 = _tuple$1; $f.cover = cover; $f.err = err; $f.rain1 = rain1; $f.rain2 = rain2; $f.$s = $s; $f.$r = $r; return $f;
		}), funcType));
	};
	itoa = function(i) {
		var i;
	...
	NewDigitalRain = function(parent, screenCols, minSpeed, maxSpeed, brightness) {
		var _r, brightness, err, maxSpeed, minSpeed, parent, rain, screenCols, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; brightness = $f.brightness; err = $f.err; maxSpeed = $f.maxSpeed; minSpeed = $f.minSpeed; parent = $f.parent; rain = $f.rain; screenCols = $f.screenCols; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		...
		_r = rain.start(); /* */ $s = 1; case 1: if($c) { $c = false; _r = _r.$blk(); } if (_r && _r.$blk !== undefined) { break s; }
		err = _r;
		if (!($interfaceIsEqual(err, $ifaceNil))) {
			$s = -1; return [ptrType$2.nil, err];
		}
		$s = -1; return [rain, $ifaceNil];
		/* */ } return; } if ($f === undefined) { $f = { $blk: NewDigitalRain }; } $f._r = _r; $f.brightness = brightness; $f.err = err; $f.maxSpeed = maxSpeed; $f.minSpeed = minSpeed; $f.parent = parent; $f.rain = rain; $f.screenCols = screenCols; $f.$s = $s; $f.$r = $r; return $f;
	};
	$pkg.NewDigitalRain = NewDigitalRain;
	DigitalRain.ptr.prototype.start = function() {
		var $24r, _i, _ref, f, r, raf, s, $s, $deferred, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $24r = $f.$24r; _i = $f._i; _ref = $f._ref; f = $f.f; r = $f.r; raf = $f.raf; s = $f.s; $s = $f.$s; $deferred = $f.$deferred; $r = $f.$r; } var $err = null; try { s: while (true) { switch ($s) { case 0: $deferred = []; $curGoroutine.deferStack.push($deferred);
		f = [f];
		r = [r];
		raf = [raf];
		r[0] = this;
		...
		$deferred.push([$methodVal(r[0], "layout"), []]);
		f[0] = $throwNilPointerError;
		f[0] = (function(f, r, raf) { return function $b(timestampJS) {
			var timestampJS, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; timestampJS = $f.timestampJS; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$global[$externalize(raf[0], $String)]($externalize(f[0], funcType$1));
			$r = r[0].loop(($parseFloat(timestampJS) / 1000)); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			$s = -1; return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.timestampJS = timestampJS; $f.$s = $s; $f.$r = $r; return $f;
		}; })(f, r, raf);
		$global[$externalize(raf[0], $String)]($externalize(f[0], funcType$1));
		$24r = $ifaceNil;
		$s = 1; case 1: return $24r;
		/* */ } return; } } catch(err) { $err = err; $s = -1; return $ifaceNil; } finally { $callDeferred($deferred, $err); if($curGoroutine.asleep) { if ($f === undefined) { $f = { $blk: DigitalRain.ptr.prototype.start }; } $f.$24r = $24r; $f._i = _i; $f._ref = _ref; $f.f = f; $f.r = r; $f.raf = raf; $f.s = s; $f.$s = $s; $f.$deferred = $deferred; $f.$r = $r; return $f; } }
	};
	DigitalRain.prototype.start = function() { return this.$val.start(); };
	DigitalRain.ptr.prototype.layout = function() {
		var _r, _r$1, _tmp, _tmp$1, _tmp$2, height, r, ratio, width, x, x$1, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; _r$1 = $f._r$1; _tmp = $f._tmp; _tmp$1 = $f._tmp$1; _tmp$2 = $f._tmp$2; height = $f.height; r = $f.r; ratio = $f.ratio; width = $f.width; x = $f.x; x$1 = $f.x$1; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		r = [r];
		r[0] = this;
		ratio = $parseFloat($global.devicePixelRatio);
		width = $parseFloat(r[0].parent.offsetWidth) * ratio;
		height = $parseFloat(r[0].parent.offsetHeight) * ratio;
		if (!(r[0].canvas === null) && (r[0].width === width) && (r[0].height === height) && (r[0].ratio === ratio)) {
			$s = -1; return;
		}
		_tmp = width;
		_tmp$1 = height;
		...
		r[0].ratio = _tmp$2;
		if (!(r[0].canvas === null)) {
			r[0].parent.removeChild(r[0].canvas);
		}
		r[0].canvas = $global.document.createElement($externalize("canvas", $String));
		r[0].ctx = r[0].canvas.getContext($externalize("2d", $String));
		r[0].canvas.width = r[0].width;
		r[0].canvas.height = r[0].height;
		r[0].canvas.style.width = $externalize(ftoa(r[0].width / r[0].ratio) + "px", $String);
		r[0].canvas.style.height = $externalize(ftoa(r[0].height / r[0].ratio) + "px", $String);
		r[0].canvas.style.position = $externalize("absolute", $String);
		r[0].parent.appendChild(r[0].canvas);
		if (r[0].highGlyphCanvas === ptrType.nil) {
			r[0].highGlyphCanvas = (x = (_r = index % 2, _r === _r ? _r : $throwRuntimeError("integer divide by zero")), ((x < 0 || x >= highGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : highGlyphCanvases.$array[highGlyphCanvases.$offset + x]));
		}
		if (r[0].lowGlyphCanvas === ptrType.nil) {
			r[0].lowGlyphCanvas = (x$1 = (_r$1 = index % 2, _r$1 === _r$1 ? _r$1 : $throwRuntimeError("integer divide by zero")), ((x$1 < 0 || x$1 >= lowGlyphCanvases.$length) ? ($throwRuntimeError("index out of range"), undefined) : lowGlyphCanvases.$array[lowGlyphCanvases.$offset + x$1]));
		}
		r[0].canvas.addEventListener($externalize("click", $String), $externalize((function(r) { return function $b(ev) {
			var ev, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; ev = $f.ev; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			/* */ if (r[0].overLink($parseInt(ev.x) >> 0, $parseInt(ev.y) >> 0)) { $s = 1; continue; }
			/* */ $s = 2; continue;
			/* if (r[0].overLink($parseInt(ev.x) >> 0, $parseInt(ev.y) >> 0)) { */ case 1:
				$global.location = $externalize(githubLink, $String);
				$s = 3; continue;
			/* } else { */ case 2:
				/* */ if (!(r[0].Clicked === $throwNilPointerError)) { $s = 4; continue; }
				/* */ $s = 5; continue;
				/* if (!(r[0].Clicked === $throwNilPointerError)) { */ case 4:
					$r = r[0].Clicked(); /* */ $s = 6; case 6: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
				/* } */ case 5:
			/* } */ case 3:
			$s = -1; return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.ev = ev; $f.$s = $s; $f.$r = $r; return $f;
		}; })(r), funcType$1));
		r[0].canvas.addEventListener($externalize("mousemove", $String), $externalize((function(r) { return function(ev) {
			var ev;
			if (r[0].overLink($parseInt(ev.x) >> 0, $parseInt(ev.y) >> 0)) {
				r[0].canvas.style.cursor = $externalize("pointer", $String);
				r[0].linkover = true;
			} else {
				r[0].canvas.style.cursor = $externalize("default", $String);
				r[0].linkover = false;
			}
		}; })(r), funcType$1));
		$r = r[0].loop(r[0].timestamp); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		$s = -1; return;
		/* */ } return; } if ($f === undefined) { $f = { $blk: DigitalRain.ptr.prototype.layout }; } $f._r = _r; $f._r$1 = _r$1; $f._tmp = _tmp; $f._tmp$1 = _tmp$1; $f._tmp$2 = _tmp$2; $f.height = height; $f.r = r; $f.ratio = ratio; $f.width = width; $f.x = x; $f.x$1 = x$1; $f.$s = $s; $f.$r = $r; return $f;
	};
	...
	DigitalRain.ptr.prototype.loop = function(timestamp) {
		var _i, _r, _r$1, _r$2, _r$3, _ref, age, brightness, drop, drops, elapsed, gbrightness, gcount, gl, glyph, i, r, ri, ri$1, row, timestamp, x, x$1, $s, $deferred, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _i = $f._i; _r = $f._r; _r$1 = $f._r$1; _r$2 = $f._r$2; _r$3 = $f._r$3; _ref = $f._ref; age = $f.age; brightness = $f.brightness; drop = $f.drop; drops = $f.drops; elapsed = $f.elapsed; gbrightness = $f.gbrightness; gcount = $f.gcount; gl = $f.gl; glyph = $f.glyph; i = $f.i; r = $f.r; ri = $f.ri; ri$1 = $f.ri$1; row = $f.row; timestamp = $f.timestamp; x = $f.x; x$1 = $f.x$1; $s = $f.$s; $deferred = $f.$deferred; $r = $f.$r; } var $err = null; try { s: while (true) { switch ($s) { case 0: $deferred = []; $curGoroutine.deferStack.push($deferred);
		r = this;
		/* */ if ((timestamp === 0) || (r.timestamp === 0)) { $s = 1; continue; }
		/* */ $s = 2; continue;
		/* if ((timestamp === 0) || (r.timestamp === 0)) { */ case 1:
		...
		r.drops = drops;
		$s = -1; return;
		/* */ } return; } } catch(err) { $err = err; $s = -1; } finally { $callDeferred($deferred, $err); if($curGoroutine.asleep) { if ($f === undefined) { $f = { $blk: DigitalRain.ptr.prototype.loop }; } $f._i = _i; $f._r = _r; $f._r$1 = _r$1; $f._r$2 = _r$2; $f._r$3 = _r$3; $f._ref = _ref; $f.age = age; $f.brightness = brightness; $f.drop = drop; $f.drops = drops; $f.elapsed = elapsed; $f.gbrightness = gbrightness; $f.gcount = gcount; $f.gl = gl; $f.glyph = glyph; $f.i = i; $f.r = r; $f.ri = ri; $f.ri$1 = ri$1; $f.row = row; $f.timestamp = timestamp; $f.x = x; $f.x$1 = x$1; $f.$s = $s; $f.$deferred = $deferred; $f.$r = $r; return $f; } }
	};
